...
HBWABotInc.sendMessage(from, { video: { url: downloadrawh2.data.result.link[downloadrawh2.data.result.link.length - 1].link  }, mimetype: 'video/mp4', caption : `*F A C E   B O O OK*`}, { quoted: m })
}
break
...
HBWABotInc.sendMessage(from, { video: { url: downloadrawh3.data.result.link[downloadrawh3.data.result.link.length - 1].link }, mimetype: 'video/mp4', caption : `*T W I T T E R*`}, { quoted: m })
}
			break
