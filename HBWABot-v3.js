...
break
            case 'delete': case 'del': {
                ...
                if (!isBaileys) return replygcherbert('Bot message lo chu ka delete thei lo!')
...
case 'bass': case 'blown': case 'deep': case 'earrape': case 'fast': case 'fat': case 'nightcore': case 'reverse': case 'robot': case 'slow': case 'smooth': case 'squirrel':
                ...
                break
                case 'can': {
            	if (!text) return replygcherbert(`Ask question\n\nTiang hian:  ${prefix + command} i dance?`)
            	let bisa = [`Can`,`Can't`,`Cannot`,`Of Course You Can!!!`]
                let keh = bisa[Math.floor(Math.random() * bisa.length)]
                let jawab = `*Can ${text}*\nAnswer : ${keh}`
            await replygcherbert(jawab)
            }
            break
            case 'is': {
            	if (!text) return replygcherbert(`Ask question\n\nTiang hian:  ${prefix + command} she virgin?`)
            ...
            break
            case 'when': {
            	if (!text) return replygcherbert(`Ask question\n\nTiang hian:  ${prefix + command} will i get married?`)
            ...
            break
case 'what': {
            	if (!text) return replygcherbert(`Ask question\n\nTiang hian:  ${prefix + command} is your name?`)
...
if (!text) return replygcherbert(`Ask question\n\nTiang hian:  ${prefix + command} is your name?`)
            ...
            break
case 'how': {
            	if (!text) return replygcherbert(`Ask question\n\nTiang hian:  ${prefix + command} to date girl?`)
