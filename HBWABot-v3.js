...
case 'listblock': case 'listban': case 'blocklist': case 'banlist': {
	...
	break
            case 'delete': case 'del': {
                ...
                if (!isBaileys) return replyherbertstyle('He message hi bot message a ni lo!')
...
teks += `│\n└────────────⭓\n\n*Totally there are : ${StickerHerbert.length}*`
replyherbertstyle(teks)
}
break
case 'addvn':{
...
teks += `│\n└────────────⭓\n\n*Totally there are : ${VoiceNoteHerbert.length}*`
replyherbertstyle(teks)
}
break
  ...
  case 'dare':
    ...
    "breakup with your best friend for 5hrs without telling him/her that its a dare",
     ...
     "send abusive words in any grup, excepting this grup, and send screenshot proof here"
              ...
              HBWABotInc.sendMessage(from, { image: bufferdare, caption: '_You choose DARE_\n'+ herbertdare }, {quoted:m})
              break
                            break
       case 'truth':
              const truth =[
    ...
    "do you play pubg, if you then send ur id number"
              ...
              HBWABotInc.sendMessage(from, { image: buffertruth, caption: '_You choose TRUTH_\n'+ herberttruth }, {quoted:m})
              break
...
case 'myip': {
        ...
        break
case 'gdrive': {
		if (!args[0]) return replyherbertstyle(`Google Drive link rawn dag rawg`)
	m.reply(mess.wait)
	const fg = require('api-dylux')
	try {
